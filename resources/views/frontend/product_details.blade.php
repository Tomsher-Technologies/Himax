        ...
        <div class="container">
            <div id="product-dt">
                    ...
                    <div id="main-image-slider" class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img
                                    src="{{ get_product_image($product->thumbnail_img ?? '', '300') }}"
                ...
                <div id="product-dt-info">
                    ...
                    <a href="#" id="cta-button" class=" mt-4" data-bs-toggle="modal"
                        data-bs-target="#enquiryModal">Request a Quote</a>

                    @if ($product->datasheet_pdf != null)
                        <a href="{{ asset($product->datasheet_pdf) }}" target="_blank" id="cta-button"
                            class=" mt-3">Product Datasheet</a>
                    @endif

                    @if ($product->getTranslation('specification', $lang) != null)
            ...
            $('#productEnquiryForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        let errorMsg = errors ? Object.values(errors).join('<br> ') :
