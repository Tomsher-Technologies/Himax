            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <article id="blog-details-article">
                        <span class="mb-2" style="color: #202857">|
                            {{ date('M d, Y', strtotime($blog->blog_date)) }}</span><br>
                        <div class="mt-3">
                            {!! $blog->description !!}
                        </div>
                    </article>
                    ...
                    <aside id="blog-details-sidebar">
                            ...
                            <ul id="blog-details-recent-list">
                                @if (!empty($recentBlogs[0]))
                                    @foreach ($recentBlogs as $rblog)
                                        <li><a
                                                href="{{ route('blog-detail', ['slug' => $rblog->slug]) }}">{{ $rblog->name }}</a>
                                        </li>
                                    @endforeach
                                @endif
                            </ul>
                        ...
                        <div id="blog-details-social">
                            ...
                            <div id="blog-details-social-links">
                                ...
                                <a href="{{ get_setting('twitter_link') }}" target="_blank"><i
