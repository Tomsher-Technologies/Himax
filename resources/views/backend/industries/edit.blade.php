            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('industries.update', $industry->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{ trans('messages.name') }}" id="name" name="name"
                                class="form-control" value="{{ old('name', $industry->name) }}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{ trans('messages.image') }}<br>
                            <small>(Image size - 1072 x 437)</small></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Enter.." id="title" name="title" class="form-control"
                    ...
                    <div class="form-group  row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control" name="status">
                                <option {{ old('status', $industry->status) == 1 ? 'selected' : '' }} value="1">
                                    {{ trans('messages.yes') }}
                                </option>
                                <option {{ old('status', $industry->status) == 0 ? 'selected' : '' }} value="0">
                                    {{ trans('messages.no') }}
                                </option>
                            </select>
                        </div>
