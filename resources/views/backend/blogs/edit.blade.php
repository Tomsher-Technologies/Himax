                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="name" value="{{ $blog->name }}" class="form-control"
                                id="name" onchange="title_update(this)" placeholder="{{ trans('messages.name') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control aiz-tag-input" data-max-tags="2" name="tags[]"
                                placeholder="{{ trans('messages.type_hit_enter_add_tag') }}" value="{{ $blog->tags }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="YYYY-MM-DD" id="blog_date" name="blog_date"
                                class="form-control " value="{{ old('blog_date', $blog->blog_date) }}" autocomplete="off">
                            @error('blog_date')
                                <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
