                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="heading15"
                                    value="{{ old('heading15', $page->getTranslation('heading15', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="heading16"
                                    value="{{ old('heading16', $page->getTranslation('heading16', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="heading17"
                                    value="{{ old('heading17', $page->getTranslation('heading17', $lang)) }}" required>
                            </div>
                        </div>
                                                    ...
                                                    <select class="form-control aiz-selectpicker" name="home_categories[]"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            ...
                                                            @foreach ($category->childrenCategories as $childCategory)
                                                                @include(
                                                                    'backend.categories.child_category',
                                                                    [
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label" for="signinSrEmail">Image
                                <br> <small>(Image size - 800 x 800)</small>
                            </label>
                            <div class="col-md-10">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="heading18"
                                    value="{{ old('heading18', $page->getTranslation('heading18', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="heading19"
                                    value="{{ old('heading19', $page->getTranslation('heading19', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="repeater">
                                ...
                                @if (!empty($home_points[0]))
                                    @foreach ($home_points as $key => $point)
                                        <div data-repeater-item>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label" for="signinSrEmail">Image
                                                    <br> <small>(Image size - 1360 x 500)</small>
                                                </label>
                                                <div class="col-md-10">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount">
                                                            {{ trans('messages.choose_file') }}</div>
                            ...
                            <button type="button" class="btn btn-soft-success mb-2" data-repeater-create>Add New
                            </button>
                        </div>
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row @if ($lang != 'en') d-none @endif">
                            ...
                            <div class="col-md-10">
                                ...
                                <select name="featured_services[]" class="form-control aiz-selectpicker" multiple
                                    data-actions-box="true" data-live-search="true" title="Select"
                                    data-selected="{{ get_setting('featured_services') }}">
                        ...
                        <div class="form-group row @if ($lang != 'en') d-none @endif">
                            ...
                            <div class="col-md-10">
                                ...
                                <select name="featured_products[]" class="form-control aiz-selectpicker" multiple
                                    data-live-search="true" title="Select Products"
                                    data-selected="{{ get_setting('featured_products') }}">
                                    {{-- <option disabled value=""></option> --}}
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">Title <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="content2"
                                    value="{{ old('content2', $page->getTranslation('content2', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter..." name="content3"
                                    value="{{ old('content3', $page->getTranslation('content3', $lang)) }}" required>
                            </div>
                        </div>
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ trans('messages.heading') }}"
                                    name="heading10"
                                    value="{{ old('heading10', $page->getTranslation('heading10', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <select name="home_brands[]" id="home_brands" class="form-control aiz-selectpicker"
                                    multiple data-live-search="true" data-actions-box="true"
                                    data-selected="{{ get_setting('home_brands') }}">
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ trans('messages.heading') }}"
                                    name="heading11"
                                    value="{{ old('heading11', $page->getTranslation('heading11', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ trans('messages.heading') }}"
                                    name="heading12"
                                    value="{{ old('heading12', $page->getTranslation('heading12', $lang)) }}" required>
                            </div>
                        </div>
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ trans('messages.heading') }}"
                                    name="heading13"
                                    value="{{ old('heading13', $page->getTranslation('heading13', $lang)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ trans('messages.heading') }}"
                                    name="heading14"
                                    value="{{ old('heading14', $page->getTranslation('heading14', $lang)) }}" required>
                            </div>
                        </div>
                ...
                <form class="p-4" action="{{ route('business_settings.update') }}" method="POST"
                    ...
                    <div class="card-body px-0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.meta_description') }}"
                                    name="meta_description" rows="5">{!! $page->getTranslation('meta_description', $lang) !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="5" class="resize-off form-control" placeholder="{{ trans('messages.meta_keywords') }}"
                                    name="keywords">{!! $page->getTranslation('keywords', $lang) !!}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.og_description') }}" name="og_description"
                                    rows="5">{!! $page->getTranslation('og_description', $lang) !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" rows="5" placeholder="{{ trans('messages.twitter_description') }}"
