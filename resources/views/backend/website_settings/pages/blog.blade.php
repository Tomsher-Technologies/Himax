        ...
        <form class="p-4" action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row @if ($page->type == 'news') d-none @endif">
                    <label class="col-sm-2 col-from-label" for="name">Title </label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Title" name="heading2"
                ...
                <div class="form-group row @if ($page->type == 'news') d-none @endif">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Title" name="heading3"
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">Subtitle</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Subtitle" name="title3"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Title" name="heading1"
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="signinSrEmail">Background Image
                        <br> <small>(Image size - 1920 x 469)</small>
                    </label>
                    <div class="col-md-10">
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            <div class="input-group-prepend">
