                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row ">
                            <label class="col-md-12 col-from-label">Header Logo
                                <small>(Image size - 150 x 57)</small>
                            </label>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Phone number"
                                            name="main_contact_number" value="{{ get_setting('main_contact_number') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="header_services[]" class="form-control aiz-selectpicker" multiple
                                data-actions-box="true" data-live-search="true" title="Select"
                                data-selected="{{ get_setting('header_services') }}">
